...
<html>
	<head>
		<title>.:. Pacientes removidos com sucesso .:. Projeto Neural TB .:.</title>
	</head>
	<body>
		<center>
		<table border="0">
		<tr>
			<td><center><font size="5" > Pacientes Removidos </font></center></td>
		</tr>
		<tr><td></td></tr>
		<tr><td></td></tr>
		</table>
			...
			<tr bgcolor="#CCCCFF">
				...
				<td>
					<table border="0">
						...
						<tr>
							<td>Automével: <xsl:value-of select="automovel" />&#160;</td>
						</tr>
						<tr>
